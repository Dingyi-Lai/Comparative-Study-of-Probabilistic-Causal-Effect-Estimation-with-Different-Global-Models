...
output_path = "./datasets/binary_data/calls911/moving_window/"
...
if __name__ == '__main__':
    ...
    tfrecord_writer = tw.TFRecordWriter(
        ...
        train_file_path = 'datasets/text_data/calls911/moving_window/callsMT2_train_' + \
            str(output_size) + '_' + str(input_size) + '.txt',
        validate_file_path = 'datasets/text_data/calls911/moving_window/callsMT2_validation_' + \
            str(output_size) + '_' + str(input_size) + '.txt',
        test_file_path = 'datasets/text_data/calls911/moving_window/callsMT2_test_' + \
            str(output_size) + '_' + str(input_size) + '.txt',
