# python preprocess_scripts/sim/create_tfrecords.py
import sys
sys.path.insert(0, ".")
...
output_path = "./datasets/binary_data/sim/moving_window/"
...
if __name__ == '__main__':
    ...
    for length, amount, ln, te in itertools.product(time_series_lengths, amount_of_time_series, dgp, te_intervention):
        tfrecord_writer = tw.TFRecordWriter(
            ...
            train_file_path = 'datasets/text_data/sim/moving_window/sim_'+\
                str(amount) + '_' + str(length) + '_' + ln + '_' + te + '_train'+\
                    '_' + str(output_size) + '_' + str(input_size) + '.txt',
            validate_file_path = 'datasets/text_data/sim/moving_window/sim_'+\
                str(amount) + '_' + str(length) + '_' + ln + '_' + te + '_validation'+\
                    '_' + str(output_size) + '_' + str(input_size) + '.txt',
            test_file_path = 'datasets/text_data/sim/moving_window/sim_'+\
