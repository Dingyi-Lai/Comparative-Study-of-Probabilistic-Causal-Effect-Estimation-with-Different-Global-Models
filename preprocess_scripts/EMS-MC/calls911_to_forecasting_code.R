...
output_file_name = 'calls911_month_full_reproduced.txt'
...
output_file_name2 = 'calls911_month_train_reproduced.txt'
...
output_file_name3 = 'calls911_month_test_reproduced.txt'
...
## train data2: dec/15 to dec/19
calls911_MONTmon_train2 <- calls911_MONTmon[,1:50] 
## test data2: jan/20 to jul/20
...
output_file_name3 = 'calls911_month_train2_reproduced.txt'
output_file_full_name3 = paste(OUTPUT_DIR, output_file_name3, sep = '')
write.table(calls911_MONTmon_train2, output_file_full_name3, sep = ",",  row.names = FALSE, col.names = FALSE)

output_file_name4 = 'calls911_month_test2_reproduced.txt'
