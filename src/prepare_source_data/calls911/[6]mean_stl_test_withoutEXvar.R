...
input_file = "./data/text_data/calls911/calls911_month_train2.txt" # train dataset with training period from Dec-15 to Dec-19
...
OUTPUT_DIR = "./data/text_data/calls911/moving_window/"
...
for (idr in 1:nrow(df_train)) {
  ...
  OUTPUT_PATH = paste(OUTPUT_PATH, '_', input_size, sep = '')
